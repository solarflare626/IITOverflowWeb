...
def question():
    if request.method == 'POST':
        ...
        requests.post('http://iitoverflow.herokuapp.com/api/users/1/question', json={
                      "question": question_title, "createdAt": date,  "updatedAt": date, "deletedAt": date, "questiondesc": question_desc, "userId": 1})
